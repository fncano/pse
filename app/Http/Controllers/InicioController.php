...
class InicioController extends Controller
{
	...
	public function create(Request $request)
    {
		...
		$transaction->totalAmount=rand(1000, 10000); // un valor para la prueba
		$transaction->description="Pago de prueba para placetopay"; // descripcion de prueba
		...
		$this->pse->setShipping('70850394','CC','prueba','SI','prueba','prueba@gmail.com','clle 73 52 - 12','Medellin','Antioquia',null,null,null);
